...
namespace P06Sklep.DataSeeder
{
    public class ProductSeeder
    {
        ...
        private const int productAdjectavieCount = 3;
        private const int product_ProductAdjectavieCount = 60;
        ...
        {
            int productAdjectiveId = 1;

            var productFaker = new Faker<ProductAdjective>("pl")
                .RuleFor(o => o.Name, f => f.Commerce.ProductAdjective())
                .RuleFor(o => o.Id, f => productAdjectiveId++);

            return productFaker.Generate(productAdjectavieCount).ToArray();
        }
        ...
        public static Product_ProductAdjective[] GenerateProduct_ProductAdjective()
        {
            var productFaker = new Faker<Product_ProductAdjective>("pl")
                ...
                .RuleFor(o => o.ProductAdjectiveId, f => f.Random.Number(1, productAdjectavieCount));

            var data =  productFaker.Generate(product_ProductAdjectavieCount).ToArray();
